...
// LOCAL MODIFICATION (esp32-display): dropped `#include "hal/spi_ll.h"`.
// Nothing in this header or the driver references spi_ll, and under an Arduino
// build it resolves only through the chip-specific hal path
