...
/* Vendored for the Arduino build: ESP-IDF's cu_pkg_define_version normally
 * generates these from idf_component.yml (component version 2.0.0). Defined
 * here so the driver's creation log lines compile unchanged. */
#ifndef ESP_LCD_GC9107_VER_MAJOR
#define ESP_LCD_GC9107_VER_MAJOR 2
#define ESP_LCD_GC9107_VER_MINOR 0
#define ESP_LCD_GC9107_VER_PATCH 0
#endif
 ...
 */
typedef struct {
    const gc9107_lcd_init_cmd_t *init_cmds;     /*!< Pointer to initialization commands array. Set to NULL if using default commands.
                                                 *   The array should be declared as `static const` and positioned outside the function.
                                                 *   Please refer to `vendor_specific_init_default` in source file.
                                                 */
    uint16_t init_cmds_size;                    /*<! Number of commands in above array */
} gc9107_vendor_config_t;

/**
 * @brief Create LCD panel for model GC9107
 *
